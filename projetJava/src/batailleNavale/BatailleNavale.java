		...
		boutonLancer.addActionListener(e -> {
			try {
				...
				if (tailleGrille < 10 || tailleGrille > 25) {
					JOptionPane.showMessageDialog(frame, "La taille de la grille doit être entre 10 et 26", "Erreur",
				...
				JOptionPane.showMessageDialog(frame, "La taille de la grille doit être un nombre valide.", "Erreur",
						JOptionPane.ERROR_MESSAGE);
			}
		});
